...
A large number of iterations is used to make the hashing operation take as long as is tolerable to us, to combat brute-force attacks. I have chosen 100k iterations, which takes a few hundred millis. I don't see why this couldn't be 1M for production use, since this takes a couple of seconds, which is tolerable for loading keys? 
