               ...
               while (1) {
                  switch (_context.prev = _context.next) {
                     case 0:
                        ...
                        _context.t0 = regeneratorRuntime.keys(this.config.components);
                     ...
                     case 2:
                        ...
                        componentConfig = this.config.components[componentName];
                        ...
                        componentModule = this.config.availableComponents[componentName];
               ...
               while (1) {
                  switch (_context3.prev = _context3.next) {
                     case 0:
                        ...
                        _arr = [].concat(_toConsumableArray(this.initedComponents));
                        _i = 0;
               ...
               while (1) {
                  switch (_context4.prev = _context4.next) {
                     case 0:
                        ...
                        _arr2 = [].concat(_toConsumableArray(this.initedComponents));
                  ...
                  switch (_context5.prev = _context5.next) {
                     ...
                     case 5:
                        ...
                        if (component.config.scheduledTimeoutWarn) {
                           _this.logger.warn(_context5.t0, component.name, component.config);
                        } else {
                  ...
                  switch (_context6.prev = _context6.next) {
                     ...
                     case 5:
                        ...
                        if (component.config.scheduledIntervalWarn) {
                           _this2.logger.warn(_context6.t0, component.name, component.config);
                        } else {
               ...
               while (1) {
                  switch (_context7.prev = _context7.next) {
                     case 0:
                        ...
                        _context7.prev = 4;
                        _iterator = this.components[Symbol.iterator]();
               ...
               while (1) {
                  switch (_context8.prev = _context8.next) {
                     case 0:
                        ...
                        _context8.next = 7;
                        return this.components.metrics.count('error', component.name);
               ...
               while (1) {
                  switch (_context9.prev = _context9.next) {
                     case 0:
                        ...
                        _context9.prev = 5;
                        _iterator2 = this.initedComponents[Symbol.iterator]();
                     ...
                     case 15:
                        ...
                        this.logger.error('end component', component.name, _context9.t0.stack);
